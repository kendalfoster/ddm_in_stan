functions{
  real ddm_lpdf(vector rt, vector resp, real a, real v, real t0, real w, real sv)
  {
    // initialize output
    real logp = 0.0;
    ...
    if (t0 < 0 || is_inf(t0) || is_nan(t0)) return negative_infinity();
...
model {
  ...
  // target += ddm_lpdf(rt | resp, a, v, t0, w, sv);
  rt ~ ddm(resp, a, v, t0, w, sv);
